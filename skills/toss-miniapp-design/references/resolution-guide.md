...
해상도는 기기마다 다르게 맞추기보다, 하나의 기준 해상도를 정하고 스케일링으로 대응하는 방식이 중요해요.
...
- **세로형 미니앱:** 약 360 x 640 ~ 420 x 740
- **가로형 미니앱:** 약 640 x 360 ~ 740 x 420
...
모든 해상도를 개별 대응하기보다, 대표적인 해상도 범위를 기준으로 설계하는 방식이 가장 효율적이에요.
